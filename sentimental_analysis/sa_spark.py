...
def main(in_dir):
    ...
    hash_transformer = HashingTF(inputCol="tokenized", outputCol="raw_vector", numFeatures=900)
    ...
    dt = MultilayerPerceptronClassifier(labelCol="label", featuresCol="features", layers=[900, 500, 2], maxIter=100,blockSize=128,seed=42, stepSize=0.025)
